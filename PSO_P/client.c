...
bool commandWith3Words(char* type)
{
    if (strcmp(type, "SET") == 0 || strcmp(type, "RPUSH") == 0 || strcmp(type, "LPUSH") == 0 || strcmp(type, "SADD") == 0
        ...
        || strcmp(type, "GETSET") == 0 || strcmp(type, "LREM") == 0 || strcmp(type, "ZSCORE") == 0)
        return true;
    return false;
}
bool commandWith2Words(char* type)
{
    if (strcmp(type, "GET") == 0 || strcmp(type, "DEL") == 0 || strcmp(type, "LPOP") == 0 || strcmp(type, "RPOP") == 0 ||
        strcmp(type, "SMEMBERS") == 0 || strcmp(type, "SCARD") == 0 || strcmp(type, "LIST") == 0 || strcmp(type, "SETC") == 0 || strcmp(type, "STRLEN") == 0 || strcmp(type, "ZCARD") == 0)
        return true;
    return false;
}
bool commandWith4Words(char* type)
{
    if (strcmp(type, "LRANGE") == 0 || strcmp(type, "GETRANGE") == 0 || strcmp(type, "LSET") == 0 || strcmp(type, "ZADD"))
        return true;
    return false;
}
