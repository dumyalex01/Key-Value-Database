...
bool commandWith3Words(char*type)
{
    ...
    || strcmp(type,"GETSET")==0 ||  strcmp(type,"LREM")==0 || strcmp(type,"ZSCORE")==0 || strcmp(type,"ZRANK")==0 || strcmp(type,"ZREM")==0 ||
    strcmp(type,"ZUNION")==0)
        return true;
    return false;
}
bool commandWith2Words(char*type)
{
    ...
    || strcmp(type,"ZCARD")==0 || strcmp(type,"ZDEL")==0)
        return true;
    return false;
}
bool commandWith4Words(char*type)
{
    if(strcmp(type,"LRANGE")==0 || strcmp(type,"GETRANGE")==0 || strcmp(type,"LSET")==0 || strcmp(type,"ZADD")==0 || strcmp(type,"ZCOUNT")==0 || strcmp(type,"ZINCRBY")==0 || 
    strcmp(type,"ZRANGE")==0||strcmp(type,"ZUNIONSTORE")==0)
        return true;
    return false;
}
...
{   
    ...
    {   
        ...
        {   char copie[50];
            ...
            {
                if(strncmp(messageToReceive,"OK",2)==0)
                    printf("Elementul in setul ordonat a fost adaugat cu succes!\n");
                else printf("Eroare la adaugare element in setul ordonat!\n");
            }
            else printf("%s\n",messageToReceive);
